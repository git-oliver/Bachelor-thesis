...
\sisetup{locale = DE, per-mode=fraction,parse-numbers=false}  
...
%\input{text/umsetzung}
\input{text/auswertung}
\input{text/unittests}
\input{text/probleme}
\input{text/ausblick}%Ausblick
\input{text/zusammenfassung}
\input{text/eidesstattliche_erklaerung}
\input{text/quellen}
\input{text/anhang}
